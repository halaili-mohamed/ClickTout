...
if($_GET) {
	...
	$sql= "SELECT Adresse_depart,Adresse_arrive,Date,Heure,n_cmd,prix,etat FROM commende where n_cmd = $num";
	...
	if($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
					...
					<tr><td><b><b>l'état de votre commande:</b> </td><td> </td>	<td>".$row['etat']."</td></tr>
